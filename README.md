...
解决子女不在身边、无法每次亲自陪伴父母就诊的问题。本质是子女不在场但深度参与父母就诊的伴诊场景。覆盖诊前准备 → 诊中记录 → 诊后管理与主动推送全流程，以情感连接（安心 / 内疚缓解）为驱动，以全程伴诊为付费基础。

当前为 **黑客松 MVP 版本**，目标在 10 小时内跑通核心 demo 链路。详见 [PRD.md](./PRD.md) 与 [ARCHITECTURE.md](./ARCHITECTURE.md)。
